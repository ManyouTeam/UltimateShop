...
public class FormBuyMoreGUI extends FormGUI {
    ...
    protected void constructGUI() {
        ...
        tempVal2.title(TextUtil.parse(player, ConfigManager.configManager.getString("menu.bedrock.buy-or-sell.title", "Buy More Menu",
                "item-name", item.getDisplayName(player))));

        tempVal2.input(TextUtil.parse(player, ConfigManager.configManager.getString("menu.bedrock.buy-or-sell.buttons.amount.name")), getButtonTab());
