...
public class SubGiveSellChest extends AbstractCommand {

    public SubGiveSellChest() {
        this.id = "givesellchest";
    ...
    public void executeCommandInGame(String[] args, Player player) {
        ...
        ObjectSellChest sellStick = ConfigManager.configManager.getSellChest(args[1]);
        if (sellStick == null) {
        ...
        switch (args.length) {
            case 2: case 3:
                CommonUtil.giveOrDrop(givePlayer, sellStick.getNewItem(1));
                ...
                break;
            case 4:
                CommonUtil.giveOrDrop(givePlayer, sellStick.getNewItem(Integer.parseInt(args[3])));
                LanguageManager.languageManager.sendStringText(player,
                        "give-sell-stick",
                        "player",
                        givePlayer.getName(),
    ...
    public List<String> getTabResult(String[] args, Player player) {
        ...
        switch (args.length) {
            case 2:
                for (ObjectSellChest sellStick : ConfigManager.configManager.getSellChests()) {
