...
public class MathUtil {
    ...
    public static BigDecimal applyConfiguredScale(BigDecimal value) {
    ...
    public static BigDecimal doCalculate(String mathStr, int scale) {
        try {
            return calculate(mathStr, scale);
        }
    ...
    public static Optional<BigDecimal> tryCalculate(String mathStr) {
        return tryCalculate(mathStr, scale);
    }

    public static Optional<BigDecimal> tryCalculate(String mathStr, int scale) {
        try {
            return Optional.of(calculate(mathStr, scale));
        } catch (Throwable ignored) {
            return Optional.empty();
        }
    }

    private static BigDecimal calculate(String mathStr, int scale) {
        ...
        return BigDecimal.valueOf(Crunch.evaluateExpression(mathStr))
                .setScale(scale, RoundingMode.HALF_UP);
    }
}
